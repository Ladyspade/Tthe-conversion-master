...
const lengthButton = document
  ...
  .addEventListener("click", (e) => {
    ...
    toMetric.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } inch &rarr; ${lengthUnits.imperial.inch()} mm <br>
    ...
    toImperial.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } mm &rarr; ${lengthUnits.metric.mm()} inch <br>
...
const massButton = document
  ...
  .addEventListener("click", (e) => {
    ...
    toMetric.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } ounce &rarr; ${massUnits.imperial.ounce()} gram <br>
    ...
    toImperial.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } gram &rarr; ${massUnits.metric.gram()} ounce <br>
...
const volumeButton = document
  ...
  .addEventListener("click", (e) => {
    ...
    toMetric.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } fl. ounce &rarr; ${volumeUnits.imperial.fluidOunce()} ml <br>
    ...
    toImperial.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } ml &rarr; ${volumeUnits.metric.ml()} fluid ounce <br>
...
const temperatureButton = document
  ...
  .addEventListener("click", (e) => {
    ...
    toCelsius.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } &deg;F &rarr; ${temperatureUnits.fahrenheit.fToC()} &deg;C <br>
		${input.value} &deg;K &rarr; ${temperatureUnits.kelvin.kToC()} &deg;C`;
    });
    toFahrenheit.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } &deg;C &rarr; ${temperatureUnits.celsius.cToF()} &deg;F <br>
    ...
    toKelvin.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } &deg;F &rarr; ${temperatureUnits.fahrenheit.fToK()} &deg;K <br>
...
const speedButton = document
  ...
  .addEventListener("click", (e) => {
    ...
    mileToKm.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } mph &rarr; ${speedUnits.mphToKmph()} km/hr`;
    });
    kmToMile.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } km/hr &rarr; ${speedUnits.kmphToMph()} mph`;
    });
    output.style.display = "block";
    output.innerHTML = "";
    input.value = null;
...
const timeButton = document
  ...
  .addEventListener("click", (e) => {
    ...
    hours.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } minute &rarr; ${timeUnits.hours.minTohr()} hour <br>
		${input.value} day &rarr; ${timeUnits.hours.dayTohr()} hour`;
    });
    days.addEventListener("click", (e) => {
      output.innerHTML = `${
        input.value
      } minute &rarr; ${timeUnits.days.minToDay()} day <br>
